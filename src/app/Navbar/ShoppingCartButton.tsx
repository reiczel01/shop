...
export default function ShoppingCartButton({ cart }: ShoppingCartButtonProps) {
  ...
  return (
    <div className="dropdown dropdown-end">
      <label tabIndex={0} className="btn-rounded btn btn-ghost">
        <div className="indicator">
          ...
          <span className="badge indicator-item badge-ghost badge-sm">
            {cart?.size || 0}
          </span>
        </div>
      </label>
      ...
      >
        <div className="card-body">
          <span className="text-sm font-bold">{cart?.size || 0} Produktów</span>
