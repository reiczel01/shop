export default function Rodo() {
  return (
    <div className="flex flex-wrap whitespace-pre-line">
      ...
      <div>
        <h2 className="divider pb-4 pt-4 text-center text-lg">
        ...
        <ol>
          ...
          <li>
            Adres kontaktowy poczty elektronicznej operatora: info@shopla.pl
          </li>
        ...
        <ol>
          ...
          <li className="py-4">
            ...
            instrukcjami:
            <ul className="link-success link">
              <li>
            ...
            <p className="pt-4">Urządzenia mobilne:</p>
            <ul className="link-success link">
              <li>
                <a href="http://support.google.com/chrome/bin/answer.py?hl=pl&amp;answer=95647">
                  Android
